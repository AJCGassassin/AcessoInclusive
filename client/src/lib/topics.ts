export const topics = [
  {
    ...
    description: "Entenda os princípios do WCAG 2.1 e as heurísticas de Nielsen para criar conteúdo web acessível e usável",
    sections: [
      ...
      { id: "visibilidade", title: "1. Visibilidade do Status do Sistema", level: 2 },
      { id: "correspondencia", title: "2. Correspondência com o Mundo Real", level: 2 },
      { id: "controle", title: "3. Controle e Liberdade do Usuário", level: 2 },
      { id: "consistencia", title: "4. Consistência e Padrões", level: 2 },
      { id: "prevencao", title: "5. Prevenção de Erros", level: 2 },
      { id: "reconhecimento", title: "6. Reconhecimento em vez de Memorização", level: 2 },
      { id: "flexibilidade", title: "7. Flexibilidade e Eficiência", level: 2 },
      { id: "estetica", title: "8. Estética e Design Minimalista", level: 2 },
      { id: "erros", title: "9. Ajuda aos Usuários com Erros", level: 2 },
      { id: "ajuda", title: "10. Ajuda e Documentação", level: 2 }
    ],
    content: `
      <h1>Diretrizes WCAG 2.1 e Heurísticas de Nielsen</h1>
      <p>Este guia combina os princípios essenciais de acessibilidade do WCAG 2.1 com as heurísticas de usabilidade de Nielsen, fornecendo uma abordagem completa para criar interfaces web acessíveis e usáveis.</p>
      ...
      <p>Forneça alternativas para mídias baseadas em tempo.</p>
      ...
      <p>As heurísticas de Nielsen complementam os princípios WCAG, focando na usabilidade geral da interface.</p>

      <h3 id="visibilidade">1. Visibilidade do Status do Sistema</h3>
      ...
      <h3 id="correspondencia">2. Correspondência com o Mundo Real</h3>
      ...
      <h3 id="controle">3. Controle e Liberdade do Usuário</h3>
      ...
      <h3 id="consistencia">4. Consistência e Padrões</h3>
      ...
      <h3 id="prevencao">5. Prevenção de Erros</h3>
      ...
      <h3 id="reconhecimento">6. Reconhecimento em vez de Memorização</h3>
      ...
      <h3 id="flexibilidade">7. Flexibilidade e Eficiência</h3>
      ...
      <h3 id="estetica">8. Estética e Design Minimalista</h3>
      ...
      <h3 id="erros">9. Ajuda aos Usuários com Erros</h3>
      ...
      <h3 id="ajuda">10. Ajuda e Documentação</h3>
  ...
  },
  {
    ...
    content: `
      ...
      <ul>
        ...
        <li><aalt></kbd> + <kbd>→</kbd> - Avançar na história</li>
